...
- [x] M1.8 Add A.13 required events (just the ability to write them)
...
- [x] M1.12b Run DB start/migrations off main thread (hang fix)
...
- [x] M1.19 Implement immediate flush on critical moments (B.3.1)
